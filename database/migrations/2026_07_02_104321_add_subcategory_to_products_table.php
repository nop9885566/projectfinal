...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // Hide old products so they don't break existing order items but stop showing on menu
        \App\Models\Product::where('is_available', true)->update(['is_available' => false]);
        ...
        $defaultProducts = [
            ...
            // Non-Coffee - Milk (50.-)
            ['name' => 'Caramel', 'category' => 'noncoffee', 'subcategory' => 'Milk', 'price' => 50.00, 'description' => 'นมคาราเมล', 'is_available' => true],
            ['name' => 'White Chocolate', 'category' => 'noncoffee', 'subcategory' => 'Milk', 'price' => 50.00, 'description' => 'นมไวท์ช็อกโกแลต', 'is_available' => true],
            ['name' => 'Honey', 'category' => 'noncoffee', 'subcategory' => 'Milk', 'price' => 50.00, 'description' => 'นมน้ำผึ้ง', 'is_available' => true],
            ['name' => 'Vanilla', 'category' => 'noncoffee', 'subcategory' => 'Milk', 'price' => 50.00, 'description' => 'นมวานิลลา', 'is_available' => true],
            ['name' => 'Strawberry', 'category' => 'noncoffee', 'subcategory' => 'Milk', 'price' => 50.00, 'description' => 'นมสตรอว์เบอร์รี่', 'is_available' => true],
            ['name' => 'Rose', 'category' => 'noncoffee', 'subcategory' => 'Milk', 'price' => 50.00, 'description' => 'นมกุหลาบ', 'is_available' => true],
            ['name' => 'Pinky', 'category' => 'noncoffee', 'subcategory' => 'Milk', 'price' => 50.00, 'description' => 'นมชมพู', 'is_available' => true],
            ['name' => 'Mint', 'category' => 'noncoffee', 'subcategory' => 'Milk', 'price' => 50.00, 'description' => 'นมมิ้นท์', 'is_available' => true],
            ['name' => 'Butterfly Pea', 'category' => 'noncoffee', 'subcategory' => 'Milk', 'price' => 50.00, 'description' => 'นมอัญชัน', 'is_available' => true],
            ['name' => 'Hazelnut', 'category' => 'noncoffee', 'subcategory' => 'Milk', 'price' => 50.00, 'description' => 'นมเฮเซลนัท', 'is_available' => true],
            ['name' => 'Sweet Potato', 'category' => 'noncoffee', 'subcategory' => 'Milk', 'price' => 50.00, 'description' => 'นมมันม่วง', 'is_available' => true],
            ['name' => 'Salted Caramel', 'category' => 'noncoffee', 'subcategory' => 'Milk', 'price' => 50.00, 'description' => 'นมซอลท์เท็ดคาราเมล', 'is_available' => true],
            ['name' => 'Butterscotch', 'category' => 'noncoffee', 'subcategory' => 'Milk', 'price' => 50.00, 'description' => 'นมบัตเตอร์สก็อต', 'is_available' => true],
            ['name' => 'Tiramisu', 'category' => 'noncoffee', 'subcategory' => 'Milk', 'price' => 50.00, 'description' => 'นมทีรามิสุ', 'is_available' => true],
            ['name' => 'Toffee Nut', 'category' => 'noncoffee', 'subcategory' => 'Milk', 'price' => 50.00, 'description' => 'นมทอฟฟี่นัท', 'is_available' => true],
