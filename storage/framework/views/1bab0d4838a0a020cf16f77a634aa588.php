...
<head>
  ...
  <title>ชำระเงินออเดอร์ #<?php echo e($order->id); ?> | บรรจงคาเฟ่</title>
...
<div class="payment-container">
  ...
  <h2 style="color: var(--brown-dark); font-weight: 700;">ชำระเงินออเดอร์ #<?php echo e($order->id); ?></h2>
  ...
  <div class="total-price">
    ยอดชำระ: ฿<?php echo e(number_format($order->total_price, 2)); ?>

  </div>

  <form action="<?php echo e(route('orders.uploadSlip', $order->id)); ?>" method="POST" enctype="multipart/form-data" class="upload-box">
    <?php echo csrf_field(); ?>
    ...
    <?php $__errorArgs = ['slip_image'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
      <div style="color: #e74c3c; font-size: 0.85rem; margin-top: 0.5rem;"><i class="fa-solid fa-circle-exclamation"></i> <?php echo e($message); ?></div>
    <?php unset($message);
...
<?php /**PATH /var/www/html/resources/views/orders/payment.blade.php ENDPATH**/ ?>