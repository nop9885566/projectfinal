...
<div style="padding: 120px 2rem 2rem">
  <div class="container">
    ...
    <h2 style="margin-bottom:2rem">
      ...
      <span style="font-size:1rem;color:#7D8F69">(<?php echo e(auth()->user()->role); ?>)</span>
    </h2>
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:1.5rem;margin-bottom:2rem">
      <div class="contact-card" style="text-align:center">
        ...
        <div style="font-size:2rem;font-weight:700"><?php echo e($totalOrders); ?></div>
        <div>ออเดอร์ทั้งหมด</div>
      </div>
      <div class="contact-card" style="text-align:center">
        <div style="font-size:2.5rem;color:#e67e22"><i class="fa-solid fa-clock"></i></div>
        <div style="font-size:2rem;font-weight:700"><?php echo e($pendingOrders); ?></div>
        <div>ออเดอร์รอดำเนินการ</div>
      </div>
      <div class="contact-card" style="text-align:center">
        <div style="font-size:2.5rem;color:#3498db"><i class="fa-solid fa-mug-hot"></i></div>
        <div style="font-size:2rem;font-weight:700"><?php echo e($totalProducts); ?></div>
        <div>เมนูทั้งหมด</div>
      </div>
      <div class="contact-card" style="text-align:center">
        <div style="font-size:2.5rem;color:#9b59b6"><i class="fa-solid fa-users"></i></div>
        <div style="font-size:2rem;font-weight:700"><?php echo e($totalUsers); ?></div>
