...
<section id="home">
  <div class="hero-bg" style="background-image: url('<?php echo e(asset('images/welcom1.jpg')); ?>'); background-size:cover; background-position:center"></div>
    ...
    <div class="about-grid">
      <div class="about-imgs" data-reveal>
        <div class="about-main">
          <img src="<?php echo e(asset('images/about-main.jpg')); ?>" style="width:100%;height:100%;object-fit:cover;border-radius:16px">
        </div>
        <div class="about-float">
          <div class="about-float-img">
            <img src="<?php echo e(asset('images/about-two.jpg')); ?>" style="width:100%;height:100%;object-fit:cover;border-radius:16px">
          </div>
...
</html><?php /**PATH D:\projectfianl\cafe-app\resources\views/welcome.blade.php ENDPATH**/ ?>