...
<section id="menu" class="section" style="padding-top:120px; background:var(--cream); min-height:100vh">
  <div class="container">
    ...
    <div class="menu-grid active" id="tab-coffee">
      <?php $__empty_1 = true; $__currentLoopData = $products->where('category', 'coffee'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <?php echo $__env->make('partials.menu-card', compact('product'), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <div class="menu-grid" id="tab-noncoffee">
      <?php $__empty_1 = true; $__currentLoopData = $products->where('category', 'noncoffee'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <?php echo $__env->make('partials.menu-card', compact('product'), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
    ...
    <div class="menu-grid" id="tab-bakery">
      <?php $__empty_1 = true; $__currentLoopData = $products->where('category', 'bakery'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <?php echo $__env->make('partials.menu-card', compact('product'), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<form id="order-form" action="<?php echo e(route('orders.store')); ?>" method="POST" class="hidden">
  <?php echo csrf_field(); ?>
</form>
...
</html><?php /**PATH /var/www/html/resources/views/menu.blade.php ENDPATH**/ ?>